			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="nombre2-label" class="property-label"><g:message code="user.nombre2.label" default="Nombre2" /></span>
						...
						<span class="property-value" aria-labelledby="nombre2-label"><g:fieldValue bean="${userInstance}" field="nombre2"/></span>
				...
				<li class="fieldcontain">
					<span id="usuario-label" class="property-label"><g:message code="user.usuario.label" default="Usuario" /></span>
						...
						<span class="property-value" aria-labelledby="usuario-label"><g:fieldValue bean="${userInstance}" field="usuario"/></span>
				...
				<li class="fieldcontain">
					<span id="roll-label" class="property-label"><g:message code="user.roll.label" default="Roll" /></span>
						...
						<span class="property-value" aria-labelledby="roll-label"><g:fieldValue bean="${userInstance}" field="roll"/></span>
